...
export declare const method: {
    ...
    <I extends Schema.Type, O extends Schema.Type, C extends Struct = {}>(spec: Meta & {
        in: I;
        out?: O;
        handle: (input: Schema.Output<I>, context: C) => Schema.Output<O> | Promise<Schema.Output<O>> | AsyncIterable<Schema.Output<O>>;
    }): Method<Schema.Output<I> extends Struct ? Schema.Output<I> : never, Schema.Output<O> extends Struct ? Schema.Output<O> : never, C>;
};
