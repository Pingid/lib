import { get, update } from "./register.js";
import { as } from "./util/api.js";
...
var op = (schema) => {
	...
	Object.defineProperty(s, "meta", {
		enumerable: false,
		value: (k, ...args) => (update(s, { meta: { [k]: args } }), s)
	});
	return as(s);
};
var ns = (schema) => {
	const s = {
		...schema,
		operations: schema.operations.map((x) => as(x))
	};
	Object.defineProperty(s, "describe", {
		enumerable: false,
		value: (d) => (s.description = d, s)
...
var _type = (tt, json = tt) => {
	...
	Object.defineProperty(t, "default", { value: (d) => (update(t, { default: d }), t) });
	Object.defineProperty(t, "describe", { value: (d) => (update(t, { description: d }), t) });
	Object.defineProperty(t, "meta", { value: (k, ...args) => (update(t, { meta: { [k]: args } }), t) });
	return t;
};
var empty = (d) => _type({
	type: "void",
...
//#endregion
export { any, array, boolean, empty, ns, nul, number, object, op, optional, output, set, string, t, undef, union, unknown };
