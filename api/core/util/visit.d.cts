import { Operation, Api, Namespace } from '../types.cjs';
 ...
 */
export declare const findChild: (ns: Namespace | Api<Namespace>, segment: string) => Operation.Any | Namespace | undefined;
/**
...
export declare const walk: (ns: Namespace, skip?: Skip, path?: string[]) => Located<Operation.Any | Namespace>[];
/**
 ...
 * whatever it emits.
 */
export declare const operations: (ns: Namespace, skip?: Skip) => Located<Operation.Any>[];
