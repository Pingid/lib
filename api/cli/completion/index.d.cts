...
export type { Table } from './table.cjs';
export type { Resolve } from './resolve.cjs';
export { resolve, site } from './resolve.cjs';
export { MARKER, callback } from './callback.cjs';
...
export declare const Completion: {
    ...
    bash: (entries: Table.Entry[], options: import("./util.cjs").Script.Options) => string;
    zsh: (entries: Table.Entry[], options: import("./util.cjs").Script.Options) => string;
    fish: (entries: Table.Entry[], options: import("./util.cjs").Script.Options) => string;
    callback: (root: Cmd.Node, argv: readonly string[], options?: import("./callback.cjs").Callback.Options) => Promise<number>;
    MARKER: string;
};
