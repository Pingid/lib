import { Api, Namespace, Operation, Schema, Tp, Type } from '../core/index.cjs';
import { FieldMeta } from './meta.cjs';
/**
...
export declare const optional: <T extends Schema>(of: T, description?: string) => Tp<Type.Union<Tp<Type.Undefined> | T>>;
