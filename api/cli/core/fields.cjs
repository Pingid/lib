...
var inputsOf = (op) => {
	...
	const inputs$1 = require_bind.inputs(op.in);
	return {
		inputs: inputs$1,
		fields: inputs$1.properties.map((property) => {
			...
			return {
				...
				required: require_schema.defaultOf(property.json) === void 0 && fallbackFor(property) === void 0,
				default: require_schema.defaultOf(property.json)?.value
			};
		}),
...
var fieldMeta = (schema) => require_register.of(schema, "cli") ?? {};
var operationMeta = (op) => require_register.of(op, "cli") ?? {};
//#endregion
exports.fallbackFor = fallbackFor;
exports.fieldMeta = fieldMeta;
exports.inputsOf = inputsOf;
