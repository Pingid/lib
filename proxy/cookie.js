import { matchesAny, trimEnd, underPrefix } from "./util.js";
import { BasePolicy, compose } from "./base.js";
//#region lib/proxy/src/cookie.ts
var SetCookiePolicy = class SetCookiePolicy extends BasePolicy {
	constructor() {
		super(compose.nullablePipe(), (cookie) => cookie);
	}
	static create() {
	...
	*/
	pathPrefix(from, to) {
		...
		return this.step((cookie) => {
			...
			if (base === "" || underPrefix(path, base)) cookie.path = trimEnd(`${target}${path.slice(base.length)}`) || "/";
			return cookie;
		});
	}
	/**
...
//#endregion
export { CookieSet, SetCookie, SetCookiePolicy };
