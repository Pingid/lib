...
export declare class Git {
    ...
    add: (...pathspec: string[]) => import('../util/recipe.cjs').RecipeApi<{
    ...
    commit: (message?: string) => import('../util/recipe.cjs').RecipeApi<{
        all?: boolean | undefined;
    ...
    tag: (name?: string, ref?: string) => import('../util/recipe.cjs').RecipeApi<{
        force?: boolean | undefined;
    ...
    push: (remote?: string, ...refspec: string[]) => import('../util/recipe.cjs').RecipeApi<{
        force?: boolean | undefined;
        delete?: boolean | undefined;
    ...
    fetch: (remote?: string, ...refspec: string[]) => import('../util/recipe.cjs').RecipeApi<{
    ...
    branch: (name?: string, start?: string) => import('../util/recipe.cjs').RecipeApi<{
        force?: boolean | undefined;
        list?: boolean | undefined;
        delete?: boolean | undefined;
    ...
    checkout: (ref?: string) => import('../util/recipe.cjs').RecipeApi<{
        force?: boolean | undefined;
    ...
    status: () => import('../util/recipe.cjs').RecipeApi<{
    ...
    diff: (ref?: string) => import('../util/recipe.cjs').RecipeApi<{
    ...
    rev_parse: (ref?: string) => import('../util/recipe.cjs').RecipeApi<{
        short?: boolean | undefined;
