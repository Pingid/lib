...
let _lickle_trace_log = require("@lickle/trace/log");
_lickle_trace_log = require_runtime.__toESM(_lickle_trace_log, 1);
...
var l = _lickle_trace_log.default.target("workspace:shell");
var make_macro = (cb) => {
	const f = (t, ...arg) => {
		if (is_template(t)) {
