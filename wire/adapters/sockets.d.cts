 ...
 * ```
 */
export interface SocketsOptions<S, T, M extends Meta = Meta, C extends any = S> {
    encode?: ((msg: T) => unknown) | undefined;
    decode?: ((data: unknown) => T) | undefined;
    meta?: ((socket: S) => M) | undefined;
    onError?: ((err: unknown) => void) | undefined;
    extract?: (next: (s: S, m: M) => void, socket: C, meta?: unknown) => void;
}
/**
 ...
 * ```
 */
export declare const sockets: <S extends Socket, T, M extends Meta = Meta, C extends any = S>(opts?: SocketsOptions<S, T, M, C>) => Sockets<C, T, M>;
