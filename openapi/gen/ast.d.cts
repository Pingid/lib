...
export declare const index: (target: ts.TypeNode, path: readonly string[]) => ts.TypeNode;
/** `Record<K, V>`, with `Record<string, string>` the usual case. */
export declare const dict: (key?: ts.TypeNode, value?: ts.TypeNode) => ts.TypeNode;
/**
...
export declare const param: (name: string, type?: ts.TypeNode, options?: {
    optional?: boolean;
