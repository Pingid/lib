import { Api as Model } from './model.cjs';
import { Source } from './doc.cjs';
import { Op } from './ops.cjs';
export { default as ts } from '@typescript/typescript6';
/**
...
export declare const Api: {
    read: (source: Source, options?: import('./read.cjs').ReadOptions) => Promise<Model>;
    print: (api: Model, options?: import('./print.cjs').PrintOptions) => string;
    /** The same as `print`, stopping at the AST so callers can splice it into a larger file. */
    nodes: (api: Model, options?: import('./print.cjs').PrintOptions) => import('typescript').Node[];
    /** Applies a rewrite to every type in the model. */
    map: (api: Model, f: (type: import('typescript').TypeNode, at: import('./model.cjs').Site) => import('typescript').TypeNode) => Model;
};
export * as Ast from './ast.cjs';
export { Doc, type DocOptions, type Source } from './doc.cjs';
export { Emit, bind, type RequestOptions, type Shape } from './emit.cjs';
export { Decl, Is, Name, Pattern, Route } from './model.cjs';
export type { Body, In, Method, Origin, Param, Reply, Site } from './model.cjs';
export { Op, type Test } from './ops.cjs';
export type { PrintOptions } from './print.cjs';
export type { ReadOptions } from './read.cjs';
