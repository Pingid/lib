...
var STRING = f.createKeywordTypeNode(typescript.default.SyntaxKind.StringKeyword);
...
var param = (name, type, options = {}) => f.createParameterDeclaration(void 0, void 0, name, options.optional ? openapi_typescript.QUESTION_TOKEN : void 0, type, options.fallback);
