...
var param = (name, type, optional = false) => f.createParameterDeclaration(void 0, void 0, name, optional ? QUESTION_TOKEN : void 0, type);
...
//#endregion
export { NEVER$1 as NEVER, UNKNOWN$1 as UNKNOWN, alias, arrow, ast_exports, call, collapse, constant, covers, docs, empty, id, iface, intersection, key, literal, member, name, obj, param, pointerOf, print, prop, record, ref, rewrite, same, source, str, template, union, walk };
