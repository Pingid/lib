...
let _typescript_typescript6 = require("@typescript/typescript6");
_typescript_typescript6 = require_runtime.__toESM(_typescript_typescript6, 1);
...
Object.defineProperty(exports, "ts", {
	enumerable: true,
	get: function() {
		return _typescript_typescript6.default;
	}
});
